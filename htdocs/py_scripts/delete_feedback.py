...
def _get_printable_info():
    ...
    feedback_id = form.getvalue('id')

    # Удаление сообщения обратной связи из базы данных
    resp = requests.delete('http://127.0.0.1:8000/db/feedback/' + feedback_id + '/', auth=get_auth_data())
